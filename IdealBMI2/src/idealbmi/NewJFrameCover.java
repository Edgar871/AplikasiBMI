 ...
 */
public class NewJFrameCover extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrameCover
     */
    public NewJFrameCover() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Lets Count Your Body Mass Index!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewJFrameCover.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewJFrameCover().setVisible(true);
            }
        });
    }
